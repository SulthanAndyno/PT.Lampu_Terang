    ...
    <footer className={styles.footer}>
      <div className={`container ${styles.footerContainer}`}>
        <div className={styles.footerColumn}>
          <h4>Lampu Terang Tech</h4>
          <p>Menerangi dunia digital Anda dengan solusi terbaik dan terpercaya.</p>
        </div>
        <div className={styles.footerColumn}>
          <h4>Quick Links</h4>
          <ul>
      ...
      <div className={styles.footerBottom}>
        <p>&copy; {new Date().getFullYear()} PT. Lampu Terang Tech. Semua Hak Dilindungi.</p>
      </div>
    </footer>
  );
};
